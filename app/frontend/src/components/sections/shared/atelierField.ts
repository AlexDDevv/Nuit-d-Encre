...
export const atelierControlClass =
    "h-11 rounded-lg border-2 border-border bg-popover/70 text-foreground placeholder:not-italic placeholder:text-muted-foreground/45 transition-all duration-200 hover:border-primary/40 focus-visible:border-primary focus-visible:bg-popover focus-visible:ring-0 focus-visible:shadow-[0_0_0_3px_hsl(43_59%_81%/0.16)]";
