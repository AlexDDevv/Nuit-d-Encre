...
export function SealEmblem() {
    return (
        ...
        >
            ...
            <span className="absolute left-1/2 top-[-9px] z-20 -translate-x-1/2">
                <span
    ...
    return (
        <div className="flex w-full items-center justify-center px-4">
            <section
                ...
                className="fade-up relative w-full overflow-hidden rounded-2xl border-2 px-7 pb-8 pt-10 text-center sm:px-9"
                style={{
                    maxWidth: "28rem",
