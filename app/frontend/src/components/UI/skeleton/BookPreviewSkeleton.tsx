        ...
        <div className="mx-auto w-full max-w-5xl px-5 pb-24 pt-7 sm:px-8">
            ...
            <div className="grid gap-10 sm:gap-12 md:grid-cols-[300px_1fr] md:items-start">
                <div className="md:pt-2">
                    <Skeleton className="mx-auto aspect-[2/3] w-full max-w-[300px] rounded-md" />
                    <Skeleton className="mx-auto mt-4 h-3 w-40 rounded" />
                </div>

                <div className="min-w-0">
                    <Skeleton className="mb-3 h-4 w-1/2 rounded" />
                    <Skeleton className="h-10 w-4/5 rounded" />
                    <Skeleton className="mt-2 h-10 w-1/2 rounded" />
                    ...
                    <div className="mt-6 flex max-w-[52ch] flex-col gap-2 pl-7">
