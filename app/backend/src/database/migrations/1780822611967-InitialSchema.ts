...
export class InitialSchema1780822611967 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "category" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "name" character varying(100) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" uuid, CONSTRAINT "UQ_23c05c292c439d77b0de816b500" UNIQUE ("name"), CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "author" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "firstname" character varying NOT NULL, "lastname" character varying NOT NULL, "birthDate" character varying, "nationality" character varying, "biography" character varying(10000), "wikipediaUrl" character varying, "officialWebsite" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_5a0e79799d372fe56f2f3fa6871" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."user_book_status_enum" AS ENUM('to_read', 'reading', 'read', 'paused')`);
        await queryRunner.query(`CREATE TABLE "user_book" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "status" "public"."user_book_status_enum" NOT NULL DEFAULT 'to_read', "startedAt" date, "finishedAt" date, "isPublic" boolean NOT NULL DEFAULT true, "isFavorite" boolean NOT NULL DEFAULT false, "favoriteRank" integer, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid, "bookId" uuid, CONSTRAINT "UQ_user_book" UNIQUE ("userId", "bookId"), CONSTRAINT "PK_3fdacff8af7da81a1cab6bc9f17" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "book_review_vote" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "isHelpful" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "reviewId" uuid, CONSTRAINT "UQ_7dbda9563c8b0b753c3c1de5fb4" UNIQUE ("userId", "reviewId"), CONSTRAINT "PK_8d4ff884046716fef2cbb3e19d9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "book_review" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "rating" integer NOT NULL, "reviewText" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "bookId" uuid, CONSTRAINT "UQ_4b7c834da28f4a48961bcaf74ee" UNIQUE ("userId", "bookId"), CONSTRAINT "PK_ea377383a8a131c7c839aa0c21b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "book_recommendation" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "bookId" uuid, CONSTRAINT "UQ_6244fe22215f4ff0948dd596a99" UNIQUE ("userId", "bookId"), CONSTRAINT "PK_667c2694798399ad748658aeb9d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."book_format_enum" AS ENUM('hardcover', 'paperback', 'softcover', 'pocket')`);
        await queryRunner.query(`CREATE TABLE "book" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "title" character varying(255) NOT NULL, "summary" character varying(5000) NOT NULL, "isbn10" character varying(10), "isbn13" character varying(13) NOT NULL, "pageCount" integer NOT NULL, "publishedYear" integer NOT NULL, "language" character varying(5) NOT NULL, "publisher" character varying(255) NOT NULL, "format" "public"."book_format_enum" NOT NULL, "coverUrl" character varying, "isImported" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" uuid, "categoryId" uuid, "userId" uuid, CONSTRAINT "UQ_c10a44a29ef231062f22b1b7ac5" UNIQUE ("title"), CONSTRAINT "UQ_f3fe6c2f9b4945fc95e6d4fd2e6" UNIQUE ("isbn10"), CONSTRAINT "UQ_f0bd833b91e9938943e39c28cae" UNIQUE ("isbn13"), CONSTRAINT "PK_a3afef72ec8f80e6e5c310b28a4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_actions" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "type" character varying NOT NULL, "xp" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "targetId" character varying, "metadata" character varying, "userId" uuid, CONSTRAINT "PK_3c8a683381b553ee59ce5b7b13a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "title" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "label" character varying(100) NOT NULL, "minLevel" integer NOT NULL, "iconKey" character varying(100) NOT NULL, "ornamentKey" character varying(100), CONSTRAINT "PK_30e6ea2dcc2aae4a4d1f5d9e183" PRIMARY KEY ("id"))`);
