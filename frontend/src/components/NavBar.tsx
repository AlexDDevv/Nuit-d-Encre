                ...
                {categories?.map((category: CategoryType) => (
                    ...
                    >
                        <Link
                            ...
                            className="text-muted-foreground hover:text-muted flex items-center justify-center px-4 py-1.5 font-semibold transition-colors duration-200 ease-in-out"
                        >
                            {category.name}
                        </Link>
                    </li>
